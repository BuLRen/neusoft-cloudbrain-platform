...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private static final String AUTH_WHITELIST = "/api/auth/login,/api/auth/register,/api/auth/refresh,/api/auth/logout,/api/auth/me,/api/auth/captcha,/ws/voice,/ws/notification,/api/voice/,/calling/stream/,/calling/board/,/check-in,/api/medtech/internal/,/api/payment/internal/,/critical-value/stream/";
