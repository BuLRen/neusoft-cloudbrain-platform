...
export interface VisitSummary {registerId:number;visitDate?:string;visitState?:number;departmentName?:string;physicianName?:string;diagnosis?:string;preliminaryDiagnosis?:string;archiveStatus?:string;archived?:boolean;checkCount?:number;labCount?:number}
...
export interface PaymentOrderItem {id?:number;itemName?:string;categoryName?:string;quantity?:number|string;unitPrice?:number|string;totalAmount?:number|string;status?:number;statusName?:string;payTime?:string;createTime?:string}
export interface PaymentOrder {registerId:number;departmentName?:string;doctorName?:string;visitDate?:string;totalAmount:number;paidAmount:number;pendingAmount:number;status:number;statusName:string;patientName?:string;itemCount?:number;paidItemCount?:number;pendingItemCount?:number;createTime?:string;payTime?:string;items?:PaymentOrderItem[]}
export interface NotificationItem {id:number;title:string;content:string;type?:string;isRead:number;createdTime:string}
export interface PrescriptionSummary {id:number;registerId?:number;physicianName?:string;diagnosis?:string;totalAmount?:number;dispensationStatusName?:string;createTime?:string;paid?:boolean;departmentName?:string;patientName?:string;dispensationStatus?:number}
...
export const medicalApi = {
  ...
  paymentOrderDetail:(registerId:number)=>request<PaymentOrder>({url:`/payment/orders/${registerId}`}),
