...
export const medicalApi = {
  ...
  visitNotebook:(registerId:number)=>request<{examItems?:Array<{type?:string;examType?:string;sourceType?:string}>}>({url:`/registration/clinical-record/visit/${registerId}/notebook`,showError:false}),
